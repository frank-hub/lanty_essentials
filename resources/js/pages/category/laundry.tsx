...
const LantyLaundryPage: React.FC<LaundryPageProps> = ({
  ...
  const { laundryProducts } = usePage().props as { laundryProducts?: Product[] };
  ...
  return (
    <Layout>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Home Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">{LaundryName}</h1>
        ...
        <div className="text-center mt-12">
          <button onClick={() => router.visit('/shop')} className="bg-[#98a69e] text-white px-8 py-3 font-medium hover:bg-gray-700 transition-colors duration-200">
            Load More Products
          </button>
        </div>
      </main>
...
export default LantyLaundryPage;
